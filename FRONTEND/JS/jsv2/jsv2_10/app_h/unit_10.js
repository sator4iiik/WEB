...
let ar1 = ['abcd', 54, true];
let ou1 = document.querySelector('.out-1');
...
let ar2 = ['qwertY', 24, 78, false, 'asdfgh'];
...
let ar3 = ['abcd', 54, true, 'qwertY',
            24, 78, false, 'asdfgh', 66.23];
...
// Task 5
//Создайте массив ar5 длина которого больше 5. Выведите сумму нулевого, второго
// и третьего элементов массива (нуль, второй - и третий это индексы 0, 2, 3)
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
// Task 6
//Создайте массив ar6, который содержит ваше имя, знак зодиака,
// день рождения и месяц рождения. Выведите массив на страницу в div-6. Разделитель - пробел.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
let ar6 = ['Anton', 'Стрелец', 13, 'November'];

function f6() {
    document.querySelector('.out-6').innerHTML =
    ar6[0] + ' ' + ar6[1] + ' ' + ar6[2] + ' ' + ar6[3];
}
...
function f7() {
    ...
    document.querySelector('.out-7').innerHTML = ou7;
}

document.querySelector('.b-7').onclick = f7;

// Task 8
// Добавьте в массив ar8 третий (индекс 3) элемент равный
// 3.14, 4 (индекс 4) элемент равный 17, 6 элемент (индекс 6) равный
// 5. Выведите массив в .out-8. Разделитель - дефис. В .out-8-1 выведите длину массива ar8.
...
function f8() {
    ...
    document.querySelector('.out-8').innerHTML += ou8;
...
// Task 9
// Выведите последний элемент массива ar9. Вывод последнего элемента  -
// реализуйте по индексу. Чтобы рассчитать индекс последнего элемента -
// используйте на длину массива.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
function f9() {
    ...
    document.querySelector('.out-9').innerHTML = ou9;
}
...
// Индекс последнего элемента массива не указывайте напрямую,
// а вычисляйте через длину массива.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
function f10() {
    ...
    document.querySelector('.out-10').innerHTML = ou10;
}
...
// Task 11
// Напишите функцию, которая меняет местами второй (индекс 2) и четвертый
// (индекс 4) элемент массива ar11 и выводит его в out-11. Разделитель - пробел.
...
function f11() {
    ...
    document.querySelector('.out-11').innerHTML = ou11;
...
// Task 12
// Напишите функцию f12, которая меняет местами нулевой и
// последний элемент массива ar12 и выводит его в out-12.
...
// Task 15
// Используя цикл выведите на страницу элементы массива ar15,
// которые больше нуля. Разделитель - пробел.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
function f15() {
    ...
    document.querySelector('.out-15').innerHTML = ou15;
...
// Task 16
// Выполните перебор массива arr16. Четные элементы добавьте в массив
// ar16_even, нечетные в ar16_odd. Добавление в массив - по индексу,
// а не +=!!!!!. Протестируйте задачу на повторный запуск!
// Выведите ar16_odd в div.out-16-odd, а ar16_even в div.out-16-even.
// Разделитель - пробел.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
function f16() {
    ar16_odd = [];
    ar16_even = []; // очищаю массивы - если функция будет запускаться еще раз

    // перебираю исходный массив
    for (let i = 0; i < ar16.length; i++) {
        if (ar16[i] % 2 === 0) { // отрицатильное четное можно проверить с помощью !=
            //если четное то добавляю в even
            ar16_even [ar16_even.length] = ar16[i]; // добавление в массив четных по индексу
        } else {
            ar16_odd [ar16_odd.length] = ar16[i]; // добавление в массив нечетных по индексу
        }
    }

    // все массивы заполнены и их нужно вывести
    // вывожу первый
    let ou16 = '';
    for (let i = 0; i < ar16_even.length; i++) {
        ou16 += ar16_even[i] + ' ';
    }
    document.querySelector('.out-16-even').innerHTML = ou16;

    //  вывожу второй после того как отработал фор первого
    ou16 = ''; // очищаю переменную
    for (let i = 0; i < ar16_odd.length; i++) {
        ou16 += ar16_odd[i] + ' ';
    }
    document.querySelector('.out-16-odd').innerHTML = ou16;
...
// Task 17
// Используя цикл выведите в .out-17 количество элементов ar17,
// значение которых больше 3. Для расчета используйте цикл и переменную счетчик.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
function f19() {
    ...
    document.querySelector('.out-19').innerHTML = ou19;
}
