...
let button01 = document.querySelector('.b-1');
...
let button02 = document.querySelector('.b-2');
...
let button03 = document.querySelector('.b-3');
...
let button04 = document.querySelector('.b-4');
let div04    = document.querySelector('.out-4');


function t4() {
    let out = '';
    for(let k = 77; k >= 35; k = k - 3) {
            out += k + '_';
    }
    div04.innerHTML = out;
}
...
let button05 = document.querySelector('.b-5');
...
let button06 = document.querySelector('.b-6');
...
let button07 = document.querySelector('.b-7');
let div07    = document.querySelector('.out-7');

function t7() {
    let out7 = '';
    let in07 = document.querySelector('.i-7').value;
    for(let i = in07; i >= 0; i--) {
        out7 += i + '_';
    }
    div07.innerHTML = out7;
}
...
let button08 = document.querySelector('.b-8');
let div08    = document.querySelector('.out-8');

function t8() {
    let out8 = '';
    let in81 = document.querySelector('.i-81').value;
    let in82 = document.querySelector('.i-82').value;

    for(let i = in81; i <= in82; i++){
        out8 += i + '_';
    }
    div08.innerHTML = out8;
}
...
// По нажатию кнопки .b-9 должна запускаться функция t9, которая выводит
...
function t9() {
    ...
    if(in91 <= in92){
        for(let i = in91; i <= in92; i++) {
            ...
            for(let i = in92; i <= in91; i++) {
                out9 += i + '_';
            }
    }
    div09.innerHTML = out9;
}
...
// годы от 1950 до 1970 включительно.
// Разделитель - знак подчеркивания. Задача решается через цикл, а четность -
// через шаг (равный 2).
...
function t15() {
    ...
    for(let max = 10; max >= 0; max--) {
        ...
        m += max + '_' + (10 - max) + '_'; //+= добавить и прировнять в цикле 1_2_3_ | = просто перезаписать значение
    }
    div15.innerHTML = m + '\u{1F600}';
}
