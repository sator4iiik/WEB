...
function t1() {
    div01.innerHTML = a1; // процедурная функция ибо ничего не возвращает
}
...
// Давайте сделаем так, чтобы функция, была более гибкой. Пусть теперь функция t2
// возвращает (return) переменную a2. Поскольку функция возвращает переменную, то имя
// функции со скобками (вызов функции) можно встраивать в выражения. Обратите внимание,
...
document.querySelector('.b-2').onclick = function () {
    ...
    console.log(t2() * t2() * t2()); // 512      // вот это интерестно ибо функция помножена друг на друга трижды
}

// Task 3.
// Наша предыдущая функция, сильно все еще зависима от внешних переменных.
// Давайте сделаем ее более универсальной. Пусть функция t3 принимает 2 аргумента
// и возвращает (return) их произведение. Допишите код функции так, чтобы она
// возвращала произведение двух чисел, переданных ей в качестве аргументов a, b.
...
document.querySelector('.b-4').onclick = function () {
    document.querySelector('.out-4').textContent = t4(1992);
}


// Task 5
// Напишите функцию t5, которая принимает ваше имя в качестве параметра и
// возвращает (return) число символов в нем, где name - принятое в качестве параметра
// имя. Длину (число символов) можно посчитать используя свойство .length.
...
document.querySelector('.b-5').onclick = function () {
    document.querySelector('.out-5').textContent = t5('Oleksii');
}



// Task 6
// Напишите функцию t6, которая принимает 2 числа и возвращает случайное целое
// число от первого до второго принятого параметра. Внимание, это первая задача,
// решение которой нужно найти в google. Не пишите решение сами!
...
// Task 7
// Напишите функцию t7, которая возвращает случайный цвет в формате rgb(x,y,z)
// (строка).Где x, y, z - случайные числа в диапазоне[0, 255].

function t7(a, b) {
    let x = parseInt(Math.random() * (a - b) + b);
    let y = parseInt(Math.random() * (a - b) + b);
    let z = parseInt(Math.random() * (a - b) + b);
...
document.querySelector('.b-7').onclick = function () {
    document.querySelector('.out-7').style.background = t7(-1, 256);
}
