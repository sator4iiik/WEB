//  Task 1
// По нажатию на кнопку .b-1 функция присваивает блоку
// .out-1 ширину 200px, высоту 90px.
...
//  Task 2
// По нажатию на кнопку .b-2 функция f2, которая присваивает
// блоку .out-2 класс .bg-orange.
...
//  Task 3
// По нажатию кнопки .b-3 запускайте функцию f3,
...
//  Task 4
// По нажатию кнопки .b-4 запускайте функцию f4,
// которая делает toggle класса .bg-orange для блока out-4.
...
//  Task 5
// По нажатию .b-5 запускайте функцию f5, которая проверяет
// наличие класса .bg-orange у блока .out-4
// (да, именно у out-4 ). Результат - true или false,
// выводите в .out-5.

let out5 = document.querySelector('.out-5');

function f5() {
    const out = document.querySelector('.out-4').getAttribute('class');
    if (out == 'out-4 bg-orange') {
        out5.innerHTML = true;
    } else if (out == 'out-4') {
...
//  Task 6
// По нажатию .b-6 запускайте функцию f6, которая выводит в
// .out-6 количество параграфов с классом .p-6.
...
//  Task 9
// Усложним предыдущие задачи. С помощью цикла повесим на блоки
// .out-9 событие клик. По клику должна выполняться функция f9.
// Функция, должна добавлять класс .bg-orange тому .out-9 на котором
// кликнули.
...
//  Task 10
// Усложним предыдущие задачи. С помощью цикла повим на блоки .out-10
// событие клик. По клику должна выполняться функция f10. Функция,
// должна делать toggle класса .bg-orange тому .out-10 на котором кликнули.
...
//  Task 11
// Кнопка .b-11, запускает функцию f11. Функция создает через
// createElement div c текстом 25 и добавляет его через append в
// .out-11.
...
// через createElement div c текстом 12 и добавляет ему класс bg-12.
...
//  Task 13
// Кнопка .b-13, запускает функцию f13. Функция создает через
// createElement div c текстом pushMe и добавляет ему класс bg-orange.
// Также, созданному div добавляется событие onclick, по которому
...
//  Task 14
// Кнопка .b-14, запускает функцию f14. Функция создает через
// createElement div c текстом 14 и добавляет ему класс .bg-orange.
...
//  Task 15
// Кнопкa .b-15, которая запускает функцию f15. Функция создает через
// createElement div c текстом 15 и добавляет ему класс .bg-orange.
...
//  Task 16
// Кнопкa .b-16, которая запускает функцию f16. Функция создает через
// createElement div c текстом 16 и добавляет ему класс .bg-orange.
...
//  Task 17
// Кнопкa .b-17, которая запускает функцию f17. Функция создает через
// createElement div c текстом 17 и добавляет ему класс .bg-orange.
...
//  Task 18
// Кнопкa .b-18, которая запускает функцию f18. Функция с помощью
// getAttribute получает data-b атрибут с параграф .p-18 и выводит в .out-18.

function f18() {
    let div = document.querySelector('.p-18').getAttribute('data-b');
    document.querySelector('.out-18').innerHTML = div;
}
...
function f19() {
    let div = document.querySelectorAll('.p-19');
    let out = '';
    for (let i = 0; i < div.length; i++) {
        out += div[i].getAttribute('data-b');
    }
...
// присваивает атрибут title="go" в div.out-20. Обращаю ваше внимание - увидеть
// атрибут можно только в с помощью инструментов веб разработчика.

function f20() {
    let div = document.querySelector('.out-20').setAttribute("title", "go");
}
