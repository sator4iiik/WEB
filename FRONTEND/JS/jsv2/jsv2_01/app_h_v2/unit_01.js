...
console.log('omaewa ' + 'mou ' + 'shindairu');
...
// Второй операцией - допишите в div.out-11 строку '456'. Для дозаписи примените +=. Обратите внимание - код уже набран, вам нужно удалить комментарий и изучить принцип работы.

document.querySelector('div.out-11').innerHTML = '123';
document.querySelector('div.out-11').innerHTML += '345';




// Task 12.
//  На странице создан div.out-12.  Получите его в переменную a.
// С помощью innerHTML запишите внутрь переменной a число 3.1415. Изучите как в JS пишутся дроби - через точку или через запятую!

let a = document.querySelector('div.out-12').innerHTML = 3.1415;
...
let out13 = document.querySelector('div.out-13').innerHTML = '<img src="https://itgid.info/img/js20/js20_unit_01.png" alt="js">';
...
// Task 19.
// Получите div.out-19 в переменную out19. Выведите в консоль out19.
// Теперь получите в эту же переменную out19 блок div c классом out-19-test. Выведите переменную out19 в консоль. Изучите что изменилось.
...
// Task 20
// Получите div.out-20 в переменную out20. C помощью textContent запишите в
// него строку '<h2>Hi</h2>'. Изучите результат. Посмотрите как этот вывод
// отличается от вывода в 10 task.
...
// в 10 задании мы записываем код ШТМЛ прямиком в внутрь документа,
// что позволяет нам вывести результат уже интерпритируемого кода
// когда в 20 мы можем загнать код ШТМЛ который видно прям на странице
// но он не воспроизводится документом находясь просто в параграфе как выводимый текст

// из этого урока мы работалии с 4 способами доставки информацию в
// консоль
// алерт
// вывести в пустой див (кусок интерпритируемого кода/кусок неинтерпритируемого кода)
