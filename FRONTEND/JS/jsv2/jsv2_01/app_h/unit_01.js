...
// Task 3.
// Выведите в консоль строку: 'Добро '+'пожаловать '+' куда-то'

console.log('Добро' + ' ' + 'пожаловать' + ' ' + ' куда-то');
...
document.querySelector('span.out-9').innerHTML = 'world';
...
let out17 = document.querySelector('div.out-17').innerHTML;
console.log(out17);
console.dir(out17);
...
let out18 = document.querySelector('div.out-18').innerHTML;
console.log(out18 = 5);
...
let out19 = document.querySelector('div.out-19').innerHTML;
console.log(out19);
out19 = document.querySelector('div.out-19-test').innerHTML;
console.log(out19);
...
//  Вообще по хорошему бы вместо let -> const
//  Ты пишешь const это иммутабельность
//  Ты пишешь чистую функцию это иммутабельность
//  Ты не мутируешь это иммутабельность
//  Ты фризишь объект это иммутабельность
//  Ты возвращаешь новый стейт это иммутабельность
//  Ты не мутируешь стейт это иммутабельность
