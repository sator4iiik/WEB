...
// Task 3.
// На странице есть checkbox .ch-3. Напишите функцию, которая возвращает его
// value если он выбран и false если не выбран.
...
// Task 4
// На странице есть radiobutton .r-4. Напишите функцию, которая возвращет
// value выбранного radiobutton.

function t4() {
    let r4 = document.querySelector('.r-4');
    return r4.value;
}
...
// Task 5
// Напишите функцию t5, которая получает из s51 число, из s52 знак и из
// s53 число и возвращает результат математической операции над этими
// числами с этим знаком. Т.е. возвращает или сумму чисел, или
// произведение, или разность или деление.
