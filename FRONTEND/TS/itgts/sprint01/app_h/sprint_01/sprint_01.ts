...
// Task 17
// Созданы две константы b_171 и b_172. Создайте константу b_17 куда
// поместите || данных констант. Тип данных определите самостоятельно.
// Результат выведите в .out-17.
...
// Task 18
// Создайте переменную b_18, тип boolean, значение false. Создайте
// переменную b_negative куда поместите ! (отрицание) переменной b_18.
